...
run_command += "&& cl /std:c++17 "+configuration_dependant+" /MP /Fo"+game_path+"/Intermediate/Objects/"+project_configuration+"/"+project_platform + "/ "
run_command += "/Fd"+game_path+"\\Intermediate\\"+scriptName+".pdb /c /showIncludes /nologo /I"+VSSE+" /I"+VSSE+"/Plugins /I"+VSSE+"/Extern/glm /I"+VSSE+"/Extern/spdLog/include "+script_path
